...
import type { EventInfo, Fact, UncertainInfo, ChecklistItem, SentimentItem, HighFreqQuestion, ResponseTemplate, TemplateParagraph, TemplateSentence, Topic } from '@/types'
...
const mockSentiments: SentimentItem[] = [
  { id: 's1', channel: '媒体报道', title: '新京报：某化工厂爆炸致3人受伤', summary: '据新京报报道，今日凌晨2时许，某市化工园区内一化工厂发生爆炸，目前已造成3人受伤，周边2公里范围内居民已紧急疏散。', emotionLevel: 3, tendency: '客观', heat: 89, timestamp: '2026-06-19 02:45', source: '新京报', topics: ['瞒报', '救援迟缓'] },
  { id: 's2', channel: '媒体报道', title: '央视新闻：应急管理部门已赶赴现场', summary: '据央视新闻报道，事故发生后，市应急管理局、消防支队已第一时间赶赴现场处置，目前火势已得到控制。', emotionLevel: 2, tendency: '客观', heat: 95, timestamp: '2026-06-19 03:10', source: '央视新闻', topics: ['救援迟缓'] },
  { id: 's3', channel: '媒体报道', title: '某自媒体：爆炸真相疑被掩盖', summary: '有自媒体发文质疑官方通报伤亡数字，声称实际伤亡人数远超通报，但未提供可靠信源。', emotionLevel: 4, tendency: '煽动', heat: 72, timestamp: '2026-06-19 03:30', source: '某自媒体', topics: ['瞒报'] },
  { id: 's4', channel: '媒体报道', title: '澎湃新闻：环保部门监测空气质量', summary: '澎湃新闻报道，市生态环境局已在事发地周边设置3个空气质量监测点，实时监测VOCs等指标。', emotionLevel: 2, tendency: '客观', heat: 67, timestamp: '2026-06-19 03:50', source: '澎湃新闻', topics: ['空气安全'] },
  { id: 's5', channel: '短视频评论', title: '爆炸现场视频评论区', summary: '大量用户评论质疑"为什么凌晨才报道""是不是瞒报了""空气有毒为什么不说"', emotionLevel: 5, heat: 96, timestamp: '2026-06-19 03:00', topics: ['瞒报', '空气安全'] },
  { id: 's6', channel: '短视频评论', title: '居民拍到的疏散画面', summary: '评论区集中在"救援太慢""半小时后才来车""老人孩子怎么办"，情绪激动', emotionLevel: 5, heat: 88, timestamp: '2026-06-19 03:20', topics: ['救援迟缓'] },
  { id: 's7', channel: '短视频评论', title: '消防员灭火现场', summary: '多数评论表达对消防员的敬意，但也有部分质疑"为什么不早发现隐患"', emotionLevel: 3, heat: 75, timestamp: '2026-06-19 04:00', topics: ['责任追究', '投诉回应'] },
  { id: 's8', channel: '社区论坛', title: '为什么化工园区离居民区这么近？', summary: '天涯社区热帖，讨论化工园区规划问题，质疑审批流程，引发对政府监管的广泛质疑。', emotionLevel: 4, heat: 82, timestamp: '2026-06-19 03:15', topics: ['规划合规', '责任追究'] },
  { id: 's9', channel: '社区论坛', title: '这次爆炸到底死了多少人？', summary: '知乎问题帖，大量回答质疑官方通报数字，要求公布完整监控视频。', emotionLevel: 5, heat: 91, timestamp: '2026-06-19 03:40', topics: ['瞒报'] },
  { id: 's10', channel: '社区论坛', title: '化工园区安全隐患早有投诉', summary: '豆瓣帖子爆料称去年就有居民投诉异味和安全隐患，但未获回应。', emotionLevel: 4, heat: 68, timestamp: '2026-06-19 04:10', topics: ['投诉回应', '责任追究'] },
  { id: 's11', channel: '投诉热线', title: '12345热线投诉分类', summary: '截至04:00，12345热线共接到相关来电156通，其中：空气质量咨询52通、人员伤亡询问38通、疏散安置诉求31通、企业责任追究22通、其他13通。', emotionLevel: 3, heat: 70, timestamp: '2026-06-19 04:00', topics: ['空气安全', '瞒报', '投诉回应'] },
  { id: 's12', channel: '投诉热线', title: '紧急诉求集中点', summary: '居民主要诉求：1. 要求公开实时空气监测数据；2. 要求公布伤亡人员名单；3. 要求明确返回家园时间；4. 要求企业承担安置费用。', emotionLevel: 3, heat: 65, timestamp: '2026-06-19 04:15', topics: ['空气安全', '瞒报', '投诉回应'] },
]

const mockQuestions: HighFreqQuestion[] = [
  { id: 'q1', content: '是否瞒报伤亡人数？', frequency: 87, emotionLevel: 5, channels: ['媒体报道', '短视频评论', '社区论坛'], topic: '瞒报', responseSuggestion: '应尽快核实并公布准确伤亡数字，说明信息发布的时间线和原因，避免信息真空引发猜疑。' },
  { id: 'q2', content: '救援是否迟缓？出警时间多长？', frequency: 76, emotionLevel: 4, channels: ['短视频评论', '社区论坛', '投诉热线'], topic: '救援迟缓', responseSuggestion: '应公布接警时间和出警时间节点，说明救援力量调配情况，正面回应"迟缓"质疑。' },
  { id: 'q3', content: '责任人是谁？企业还是监管部门？', frequency: 72, emotionLevel: 4, channels: ['社区论坛', '媒体报道'], topic: '责任追究', responseSuggestion: '应明确已启动调查程序，通报涉事企业基本信息，表明追责决心。' },
  { id: 'q4', content: '空气质量是否安全？为什么不公布数据？', frequency: 68, emotionLevel: 4, channels: ['投诉热线', '短视频评论', '社区论坛'], topic: '空气安全', responseSuggestion: '应实时公布空气监测数据，明确安全范围和防护建议，消除公众恐慌。' },
  { id: 'q5', content: '化工园区规划是否合规？为何临近居民区？', frequency: 61, emotionLevel: 3, channels: ['社区论坛', '媒体报道'], topic: '规划合规', responseSuggestion: '应说明园区规划审批历史和安评情况，承诺重新审视安全距离标准。' },
  { id: 'q6', content: '之前的安全投诉为什么没处理？', frequency: 55, emotionLevel: 3, channels: ['社区论坛', '投诉热线'], topic: '投诉回应', responseSuggestion: '应回应历史投诉处理情况，承认不足并承诺整改，公布投诉处理机制。' },
]

function buildChecklist(event: EventInfo): ChecklistItem[] {
...
function generateResponseTemplate(event: EventInfo, questions: HighFreqQuestion[]): ResponseTemplate {
  ...
  const soothingSentences: TemplateSentence[] = [
    ...
    { id: generateId(), content: '我们理解公众对伤亡数字的关切，一旦核实确认将第一时间公布。', selected: questions.some(q => q.topic === '瞒报'), edited: false, originalContent: '我们理解公众对伤亡数字的关切，一旦核实确认将第一时间公布。' },
  ...
  const measureSentences: TemplateSentence[] = [
    ...
    { id: generateId(), content: '已安排专业人员对周边环境进行持续监测，监测数据将实时公开。', selected: questions.some(q => q.topic === '空气安全'), edited: false, originalContent: '已安排专业人员对周边环境进行持续监测，监测数据将实时公开。' },
...
const STORAGE_KEY = 'emergency_response_data'
...
function persistState(state: Partial<StoreState>) {
  try {
    localStorage.setItem(STORAGE_KEY, JSON.stringify({
      event: state.event,
      responseTemplate: state.responseTemplate,
...
export const useStore = create<StoreState>((set, get) => ({
  event: (persisted?.event as EventInfo) || defaultEvent,
  sentiments: mockSentiments,
  questions: mockQuestions,
  responseTemplate: (persisted?.responseTemplate as ResponseTemplate) || null,
  currentStep: (persisted?.currentStep as number) || 0,
  ...
  updateUncertainInfoStatus: (id, status) => {
    set((state) => ({
      event: {
        ...state.event,
  ...
  generateChecklist: () => {
    const checklist = buildChecklist(get().event)
  ...
  toggleSentence: (paragraphKey, sentenceId) => {
    set((state) => {
  ...
  editSentence: (paragraphKey, sentenceId, content) => {
    set((state) => {
      if (!state.responseTemplate) return state
      const paragraph = state.responseTemplate[paragraphKey] as TemplateParagraph
      return {
  ...
  addSentence: (paragraphKey, content) => {
    set((state) => {
      if (!state.responseTemplate) return state
      const paragraph = state.responseTemplate[paragraphKey] as TemplateParagraph
      return {
  ...
  removeSentence: (paragraphKey, sentenceId) => {
    set((state) => {
      if (!state.responseTemplate) return state
      const paragraph = state.responseTemplate[paragraphKey] as TemplateParagraph
      return {
  ...
  resetEvent: () => {
    set({ event: defaultEvent, responseTemplate: null, currentStep: 0 })
    persistState({ event: defaultEvent, responseTemplate: null, currentStep: 0 })
  },
}))
